  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // const url = `https://newsapi.org/v2/everything?q=${query}&country=us&from=${pastDateStr}&to=${today}&apiKey=42e230b914bf4e0a8ee13747c8b13584&page=${page}`;
        const url = `https://newsapi.org/v2/everything?q=${query}&from=${pastDateStr}&to=${today}&sortBy=publishedAt&apiKey=42e230b914bf4e0a8ee13747c8b13584&page=${page}`
